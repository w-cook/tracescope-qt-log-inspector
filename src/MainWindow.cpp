    ...
    )
{
    ...
    /*
     * The timeline has already verified that this
     * request only narrows the active categorical
     * filters. Synchronize all affected controls
     * before applying one logical filter update.
     */
    {
        const QSignalBlocker severityBlocker(
            levelFilterCombo
